...
from traceratops.core.io_manager import save_json
...
def main():
    ...
    for dataset_name in list(list_data.keys()):
        ...
        print("# Post-processing of Hi-M matrices")
        print(f"""**dataset: {dataset_name}** - **Cells: {p["action"]}**""")
        p["SClabeledCollated"] = sc_labeled_collated

        if len(sc_matrix_collated) > 0:
            # [plots distance matrix for each dataset]
            print("## single dataset PWD matrices")
            print(
            ...
            print("## single dataset inverse PWD matrices")
            print(
            ...
            print("## single dataset Contact Probability matrices")
            print(
            ...
            print("## Ensemble contact probability")
            print(
